...
function getImageIcon({ imageProps, source, pressedProps, disabledProps, size = DEFAULT_SIZE, }, disabled, pressed, color) {
    if (source) {
        ...
        const _imageProps = {
            ...imageProps,
            ...(disabled && (disabledProps === null || disabledProps === void 0 ? void 0 : disabledProps.imageProps)),
            ...(pressed && (pressedProps === null || pressedProps === void 0 ? void 0 : pressedProps.imageProps)),
        };
...
function handleBadgeComponent({ badge, badgeProps, color, disabledProps, pressedProps, size = DEFAULT_SIZE, }, disabled, pressed) {
    ...
    return (<Badge_1.Badge offset={{ x: size / 3, y: -size / 3 }} size={size / 2} textColor={color} value={badge} {...{
        ...badgeProps,
        ...(disabled && (disabledProps === null || disabledProps === void 0 ? void 0 : disabledProps.badgeProps)),
        ...(pressed && (pressedProps === null || pressedProps === void 0 ? void 0 : pressedProps.badgeProps)),
    }}/>);
}
